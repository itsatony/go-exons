...
requirements:
  ...
  environment:               # the execution environment (v0.33.0) — skill and agent only
    code_execution: required # required | optional; absent = undeclared
    packages:                # INFORMATIONAL <ecosystem>:<name>; requires code_execution
      - python:openpyxl
    network: none            # required | optional | none; absent = undeclared, NOT none
```
